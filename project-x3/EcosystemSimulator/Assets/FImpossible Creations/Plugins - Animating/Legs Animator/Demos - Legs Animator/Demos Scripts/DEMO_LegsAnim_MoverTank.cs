...
namespace FIMSpace.FProceduralAnimation
{
    ...
    public class DEMO_LegsAnim_MoverTank : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            float rotationAngleDelta = 4f;
            if (Input.GetKey(KeyCode.A)) {
                // - CCW
                rotationAngle = transform.eulerAngles.y - rotationAngleDelta;
            ...
            if (moveDirectionLocal != Vector2.zero)
            {
                ...
                // TANK MOVEMENT: FORWARD BACK
                moveDirectionWorld = targetRotation * new Vector3(0f, 0f, moveDirectionLocal.y);
            ...
            Debug.Log(currentWorldAccel);
            Debug.Log(targetRotation);
            Debug.Log(moveDirectionWorld);
        ...
        private void FixedUpdate()
        {
            ...
            targetVelo = Vector3.Lerp(targetVelo, (moveDirectionLocal.y > 0 ? transform.forward : -transform.forward) * targetVelo.magnitude, directMovement);
