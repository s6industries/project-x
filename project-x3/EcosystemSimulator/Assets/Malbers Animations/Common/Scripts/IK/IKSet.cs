...
namespace MalbersAnimations.IK
{
    ...
    public class IKSet
    {
        ...
        {
            Targets ??= new Transform[0]; //Make sure the Target list is not Null
        ...
        private void GetFinalWeight(Animator anim, float finalWeight, IKProcessor processor)
        {
            ...
            if (LerpWeight > 0)
            {
                FinalWeight = Mathf.Lerp(FinalWeight, finalWeight, Time.deltaTime * LerpWeight);
            }
            else
            {
            ...
            if (Mathf.Approximately(FinalWeight, finalWeight)) FinalWeight = finalWeight;
        ...
        public virtual void Enable(bool value)
        {
            ...
            if (active) OnSetEnable.Invoke();
            else OnSetDisable.Invoke();
        }
        ...
        {
            Targets = new Transform[newTargets.Length];
