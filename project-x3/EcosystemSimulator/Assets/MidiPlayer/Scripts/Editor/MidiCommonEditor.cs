...
namespace MidiPlayerTK
{
    ...
    public class MidiCommonEditor : ScriptableObject
    {
        ...
        public void MidiFileParameters(MidiFilePlayer instance)
        {
            ...
            instance.showMidiPlaying = DrawFoldoutAndHelp(instance.showMidiPlaying, "Show MIDI Player", "https://paxstellar.fr/midi-file-player-detailed-view-2/#Foldout-Midi-Parameters");
