...
namespace MidiPlayerTK
{
    ...
    public partial class MidiFilePlayer : MidiSynth
    {
        ...
        [Header("Attributes below applies on MIDI Player")]
        /// <summary>@brief 
        /// If the value is true, MIDI playing will stop at the last note found in the MIDI.
        /// @note
        ///     - Does not affect the value of #MPTK_Duration, which remains the same.
        ///     - If enabled, MIDI plating could stop before #MPTK_Duration.
        ///     - Get midiFilePlayer.midiLoaded.MPTK_PositionLastNote for the duration at the last note.
        /// @code
